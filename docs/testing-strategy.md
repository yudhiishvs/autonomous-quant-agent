...
Branch coverage is diagnostic. The current repository has coverage configuration but no
documented, executed branch-coverage ratchet for the target platform; that ratchet is
