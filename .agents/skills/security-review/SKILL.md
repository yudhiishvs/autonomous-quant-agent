...
Treat [security-model.md](../../../docs/security-model.md), [security_architecture.md](../../../docs/security_architecture.md), [threat_model.md](../../../docs/threat_model.md), and [SECURITY.md](../../../SECURITY.md) as the security and reporting authorities, and use [ARCHITECTURE.md](../../../ARCHITECTURE.md) for trust boundaries. Scope [market_data_runbook.md](../../../docs/market_data_runbook.md) to the collector and [live_paper_runbook.md](../../../docs/live_paper_runbook.md) plus [incident_response.md](../../../docs/incident_response.md) to the legacy paper path.
